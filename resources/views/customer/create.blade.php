...
<body>
<center><h2>客户添加<a style="float:right" href="{{url('/customer/index')}}" class="btn btn-default">列表</a></h2></center><hr/>
<!-- @if ($errors->any()) 
...
<form action="{{url('/customer/store')}}" method="post" class="form-horizontal" role="form" >
@csrf
	<div class="form-group">
		<label for="firstname" class="col-sm-2 control-label">客户名字</label>
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="c_name" placeholder="客户名字">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="c_from" placeholder="客户来源">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="c_tel" placeholder="请输入客户电话">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" id="firstname" name="c_ptel" placeholder="请输入客户手机">
