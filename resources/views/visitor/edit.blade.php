...
<body>
<center><h3>拜访会议表单修改</h3></center>
<a style="float:right" href="{{url('visitor/index')}}" class="btn btn-default">展示</a>
<form action="{{url('visitor/update/'.$res->v_id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<input type="text" name="v_man" value="{{$res->v_man}}">
				{{$errors->first('v_man')}}
		</div>
	</div>
		<div class="form-group">
		...
		<div class="col-sm-6">
			<input type="text" name="v_address"value="{{$res->v_address}}">			
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<input type="text" name="v_desc"value="{{$res->v_desc}}">
			<b style="color:red">{{$errors->first('v_desc')}}
</b>
